...
namespace IDCM.GCMControlLib
{
    ...
    public partial class GCMTabControl : TabControl
    {
            ...
            if (!DesignMode)
            {
                if (drgevent.KeyState == 1 && drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        int draggingTabIndex = ((GCMTabControl)draggingTab.Parent).TabPages.IndexOf(draggingTab);
                ...
                if (drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        if (draggingTab != over)
                        {
                            ...
                            {
                                ((GCMTabControl)draggingTab.Parent).TabPages.Remove(draggingTab);
                ...
                switch (_alignments)
                {
                    ...
                    case TabAlignments.Bottom:
                        ...
                        using (GraphicsPath gp = new GraphicsPath())
                        {
                            ...
                            // Draw tab close image.
                            if ((this.SelectedTab as TabPageEx).IsClosable)
                            {
                                if (conditionButtonStateArray[0] == ButtonState.Normal)
                                {
                                    using (ImageAttributes attributes = new ImageAttributes())
        ...
        class ButtonsCaptionEditor : UITypeEditor
        {
            ...
            public override void PaintValue(PaintValueEventArgs e)
            {
                if (e.Context.Instance is GCMTabControl)
                {
                    GCMTabControl parent = e.Context.Instance as GCMTabControl;
        ...
        class TabpageExCollectionEditor : CollectionEditor
        {
            ...
            protected override void DestroyInstance(object instance)
            {
                ...
                ISelectionService selectionService = (ISelectionService)GetService(typeof(ISelectionService));
                selectionService.SetSelectedComponents(new IComponent[] { (GCMTabControl)Context.Instance }, SelectionTypes.Auto);
            }
