...
namespace IDCM.Base.AbsInterfaces
{
    public abstract class AbsBGHandler:IBGHandler
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual Queue<AbsBGHandler> cascadeHandlers()
        {
            return nextHandlers;
        }
        /// <summary>
        ...
        public virtual void addHandler(AbsBGHandler nextHandler)
        {
            if (nextHandler == null)
                return;
            if (nextHandlers == null)
                nextHandlers = new Queue<AbsBGHandler>(0);
            nextHandlers.Enqueue(nextHandler);
        }

        protected Queue<AbsBGHandler> nextHandlers = null;
