...
namespace DCMControlLib.GCM
{
    partial class GCMTabControl
    {
        internal partial class CaptionColorChooser : Form
        {
            ...
            public GCMTabControl contextInstance;
            ...
            {
                Randomizer = new GCMTabControl.RandomizerCaption((byte)nmrRed.Value, (byte)nmrGreen.Value, (byte)nmrBlue.Value, (byte)nmrAlpha.Value,
